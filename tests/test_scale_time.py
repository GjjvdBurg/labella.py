...
def local(year, month, day, hours=0, minutes=0, seconds=0, milliseconds=0):
    ...
    date = datetime(
        year, month + 1, day, hours, minutes, seconds, milliseconds * 1000
    )
    return date
...
class TimeScaleTestCase(unittest.TestCase):
    def test_nice_1c(self):
        ...
        x = TimeScale().domain(
            [local(2009, 0, 1, 0, 12), local(2009, 0, 1, 23, 48)]
        )
        self.assertEqual(
    ...
    def test_nice_3(self):
        ...
        x = TimeScale().domain(
            [local(2009, 0, 1, 0, 17), local(2009, 0, 1, 23, 42)]
        )
        self.assertEqual(
            x.nice(100).domain(),
        ...
        self.assertEqual(
            x.nice(10).domain(), [local(2009, 0, 1), local(2009, 0, 2)]
        )
    ...
    def test_nice_4(self):
        ...
        self.assertEqual(
            x.nice().domain(), [local(2009, 0, 1), local(2009, 0, 2)]
        )
    ...
    def test_ticks_subsecond(self):
        ...
        x = TimeScale().domain(
            [local(2011, 0, 1, 12, 0, 0), local(2011, 0, 1, 12, 0, 1)]
        )
        self.assertEqual(
            x.ticks(4),
            [
    ...
    def test_ticks_second_one(self):
        ...
        x = TimeScale().domain(
            [local(2011, 0, 1, 12, 0, 0), local(2011, 0, 1, 12, 0, 4)]
        )
        self.assertEqual(
            x.ticks(4),
            [
    ...
    def test_ticks_second_five(self):
        ...
        x = TimeScale().domain(
            [local(2011, 0, 1, 12, 0, 0), local(2011, 0, 1, 12, 0, 20)]
        )
        self.assertEqual(
            x.ticks(4),
            [
    ...
    def test_ticks_second_fifteen(self):
        ...
        x = TimeScale().domain(
            [local(2011, 0, 1, 12, 0, 0), local(2011, 0, 1, 12, 0, 50)]
        )
        self.assertEqual(
            x.ticks(4),
            [
    ...
    def test_ticks_second_thirty(self):
        ...
        x = TimeScale().domain(
            [local(2011, 0, 1, 12, 0, 0), local(2011, 0, 1, 12, 1, 50)]
        )
        self.assertEqual(
            x.ticks(4),
            [
    ...
    def test_ticks_minute_one(self):
        ...
        x = TimeScale().domain(
            [local(2011, 0, 1, 12, 0, 27), local(2011, 0, 1, 12, 4, 12)]
        )
        self.assertEqual(
            x.ticks(4),
            [
    ...
    def test_ticks_minute_five(self):
        ...
        x = TimeScale().domain(
            [local(2011, 0, 1, 12, 3, 27), local(2011, 0, 1, 12, 21, 12)]
        )
        self.assertEqual(
            x.ticks(4),
            [
    ...
    def test_ticks_minute_fifteen(self):
        ...
        x = TimeScale().domain(
            [local(2011, 0, 1, 12, 8, 27), local(2011, 0, 1, 13, 4, 12)]
        )
        self.assertEqual(
            x.ticks(4),
            [
    ...
    def test_ticks_minute_thirty(self):
        ...
        x = TimeScale().domain(
            [local(2011, 0, 1, 12, 28, 27), local(2011, 0, 1, 14, 4, 12)]
        )
        self.assertEqual(
            x.ticks(4),
            [
    ...
    def test_ticks_hour_one(self):
        ...
        x = TimeScale().domain(
            [local(2011, 0, 1, 12, 28, 27), local(2011, 0, 1, 16, 34, 12)]
        )
        self.assertEqual(
            x.ticks(4),
            [
    ...
    def test_ticks_hour_three(self):
        ...
        x = TimeScale().domain(
            [local(2011, 0, 1, 14, 28, 27), local(2011, 0, 2, 1, 34, 12)]
        )
        self.assertEqual(
            x.ticks(4),
            [
    ...
    def test_ticks_hour_six(self):
        ...
        x = TimeScale().domain(
            [local(2011, 0, 1, 16, 28, 27), local(2011, 0, 2, 14, 34, 12)]
        )
        self.assertEqual(
            x.ticks(4),
            [
    ...
    def test_ticks_hour_twelve(self):
        ...
        x = TimeScale().domain(
            [local(2011, 0, 1, 16, 28, 27), local(2011, 0, 3, 21, 34, 12)]
        )
        self.assertEqual(
            x.ticks(4),
            [
    ...
    def test_ticks_day_one(self):
        ...
        x = TimeScale().domain(
            [local(2011, 0, 1, 16, 28, 27), local(2011, 0, 5, 21, 34, 12)]
        )
        self.assertEqual(
            x.ticks(4),
            [
    ...
    def test_ticks_day_two(self):
        ...
        x = TimeScale().domain(
            [local(2011, 0, 2, 16, 28, 27), local(2011, 0, 9, 21, 34, 12)]
        )
        self.assertEqual(
            x.ticks(4),
            [
    ...
    def test_ticks_week_one(self):
        ...
        x = TimeScale().domain(
            [local(2011, 0, 1, 16, 28, 27), local(2011, 0, 23, 21, 34, 12)]
        )
        self.assertEqual(
            x.ticks(4),
            [
